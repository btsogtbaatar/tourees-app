...
import { CalendarIcon, ClockIcon, LocationCircleGrayIcon, LocationIcon } from '../Icon';
      ...
      <View style={TaskListItemStyle.left}>
        ...
        <View style={TaskListItemStyle.details}>
          ...
          <View style={TaskListItemStyle.detailRow}>
            ...
            <Text style={TaskListItemStyle.info}>{formatDate(item.timeRange.start)}</Text>
          </View>
          <View style={TaskListItemStyle.detailRow}>
        ...
        <View style={TaskListItemStyle.detailRow}>
          <Text style={TaskListItemStyle.status}>{t(`request.status.${item.status}`)}</Text>
